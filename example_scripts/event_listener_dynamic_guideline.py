...
def checkForNewMaximum(document, numberOfTicks):
    ...
    if (maxValueInMostRecentSelection > blockWideMaximum):
        ...
        print("New maximum found, updating guidelines:")
        print("Upper guideline set to:", blockWideMaximum)
        print("Lower guideline set to:", blockWideMaximum - percentageOfMax/100*blockWideMaximum, "\n")
